...
const ROWS = [
  [
    { title: "Programming Languages", items: ['JavaScript', 'TypeScript', 'Java'] },
    { title: "Frontend Technologies", items: ['HTML5', 'CSS3', 'JavaScript', 'React.js', 'Redux Toolkit', 'Tailwind CSS', 'Material UI'] },
    { title: "Backend Technologies", items: ['Node.js', 'Express.js', 'REST APIs',' Authentication with JWT Sessions'] },
    { title: "Databases & Storage", items: ['MongoDB', 'MySQL', 'Redis', 'Firebase'] },  // 'Cloud Storage' , ('AWS S3, Cloudflare R2')
    { title: "DevOps & Deployment", items: ['Git' ,'GitHub' ,'GitLab' ,'Render', 'Netlify' ] },  // ,'AWS (EC2, S3 basics)' ,'Cloudflare'
    { title: "Tools & Platforms", items: [ 'Postman', 'VS Code', 'npm', 'Babel', 'PowerShell', 'Figma' ] },  
    { title: "Core CS Concepts", items: [ 'Data Structures & Algorithms',  'OOP : Object-Oriented Programming ', 'Database Management System (DBMS)'  ] },  
    { title: "Soft Skills",     items: ["Teamwork", "Problem Solving", "Creativity", "Adaptability", "Communication", "Time Management"],
    },
  ] 
];
