...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:amanpathan348@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
      `Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`
    )}`;
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      value: 'amanpathan348@gmail.com',
      href: 'https://mail.google.com/mail/?view=cm&fs=1&to=amanpathan348@gmail.com',
    },
    {
      icon: Phone,
      title: 'Phone',
      value: '+91 9321434984',
      href: 'tel:+919321434984',
    },
    {
      icon: MapPin,
      title: 'Location',
  ...
  return (
    <section id="contact" className="pb-7 relative">
